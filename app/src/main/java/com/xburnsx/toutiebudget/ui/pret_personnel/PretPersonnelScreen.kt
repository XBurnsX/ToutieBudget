                        ...
                        items(items, key = { it.key }) { item ->
                            Column(
                                ...
                                Row(
                                    ...
                                    Text("Prêté: ${MoneyFormatter.formatAmount(item.montantPrete)}", color = Color.LightGray)
                                    Text("Remboursé: ${MoneyFormatter.formatAmount(item.montantRembourse)}", color = Color.LightGray)
                                }
                            }
                        }
                    }
